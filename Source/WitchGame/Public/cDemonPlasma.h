...
#include "cDemonPlasma.generated.h"

/**
 *
 */
UCLASS()
class WITCHGAME_API AcDemonPlasma : public AcEnemyParent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracing)
		float FloorDistance = 12.5f;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Tracing)
		float TraceDistance = 0.5f;

	//**************( Timers )**************//
	float IdleDelayCurrent = 0.0f;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Timers)
		float IdleDelayMax = 1.0f;
